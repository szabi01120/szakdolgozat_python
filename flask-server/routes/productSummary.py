...
def get_sold_products_income():
    try:
        ...
        return jsonify({"total_income_huf": total_income_huf, "total_income_eur": total_income_eur}), 200
    except Exception as e:
        return jsonify({"error": str(e), "total_income_huf": 0, "total_income_eur": 0}), 500