...
export default function Quotation() {
  ...
  useEffect(() => {
    const getTemplates = async () => {
      try {
        const response = await axios.get('https://dezsanyilvantarto.hu/api/templates');
  ...
  const handleAddTemplate = async () => {
    ...
    try {
      const response = await axios.post('https://dezsanyilvantarto.hu/api/add_template', newTemplate);
  ...
  const handleDeleteTemplate = async () => {
    ...
    try {
      const response = await axios.delete('https://dezsanyilvantarto.hu/api/delete_template', { data: templateToDelete });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://dezsanyilvantarto.hu/api/send_quotation', quotationData);
      if (response.status === 200) {
