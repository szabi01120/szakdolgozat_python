...
export default function AddProduct() {
  ...
  useEffect(() => {
    const getProductTypes = async () => {
      try {
        const response = await axios.get('https://dezsanyilvantarto.hu/api/product_types');
    ...
    const getManufacturers = async () => {
      try {
        const response = await axios.get('https://dezsanyilvantarto.hu/api/product_manufacturers');
